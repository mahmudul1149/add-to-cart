...
.btn-add {
  ...
  display: flex;
  align-items: center;
  background-image: linear-gradient(to bottom,#FE8D00, #FCC225);
  color: black;
  gap: .7rem;
  padding: .5rem;
  border-radius: 5px;
